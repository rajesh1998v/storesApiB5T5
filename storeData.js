...
let users=[{email:"gmail@test.com",name:"Test",password:"12345678"}];

let orders=[
  {name:"Vishal",address:"Sector 34",city:"Ranchi",totalPrice:7136,items:6,email:"gmail@test.com"},
  {name:"Nitesh",address:"House No 02,Street 12",city:"Giridih",totalPrice:418,items:2,email:"gmail@test.com"},
  {name:"Vishal",address:"Sector 45,House 02",city:"Giridih",totalPrice:1446,items:4,email:"gmail@test.com"},
